...
% \includeonly{TightBinding,PVP,Friction,Therma,Kekule,Appendix_PVP_strainedBZ,Appendix_PVP_idependence,Appendix_Fri_Fit,Appendix_kek_hopps}
% \includeonly{Kekule,Appendix_kek_hopps,Appendix_kek_electronics}
% \includeonly{form_1_title,form_2_approval,form_4_acknowledge,form_5_abstract,form6_abbreviations}
...
\newcommand{\thesistitle}{MANIPULATING GRAPHENE'S LATTICE: PSEUDO VECTOR POTENTIALS, ANOMALOUS FRICTION, TUNABLE THERMAL CONDUCTIVITY, AND METASTABLE BAND GAP}
\newcommand{\thesistitlelower}{Manipulating graphene's lattice: Pseudo vector potentials, anomalous friction, tunable thermal conductivity, and a metastable band gap}
