...
% \includeonly{Thermal,Appendix_HeatModel}
% \includeonly{Introduction,TightBinding,PVP,Friction,Thermal,Kekule,Conclusion}
% \includeonly{Appendix_PVP_strainedBZ,Appendix_PVP_idependence,Appendix_Fri_Fit,Appendix_HeatModel,Appendix_kek_hopps,Appendix_kek_electronics}
...
\newcommand{\thesistitle}{MANIPULATING GRAPHENE'S LATTICE TO CREATE PSEUDOVECTOR POTENTIALS, DISCOVER ANOMALOUS FRICTION, AND MEASURE STRAIN DEPENDENT THERMAL CONDUCTIVITY}
\newcommand{\thesistitlelower}{Manipulating graphene's lattice to create pseudovector potentials, discover anomalous friction, and measure strain dependent thermal conductivity}
...
\hyphenation{graph-ene}						% Sets the hyphenation of graphene
\usepackage{pdfpages}						% Used to insert signed signature page
...
\begin{document}
	...
	\include{form_2_approval_signed}
