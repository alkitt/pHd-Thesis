...
\subsection{Estimation of the band gap}
...
The resistance, $R$, of the graphene device is measured using a four probe, low frequency AC, lock-in technique. 
